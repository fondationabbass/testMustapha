...
import { ParametrageDeleteDialogComponent } from '../../../../../../main/webapp/app/entities/parametrage/parametrage-delete-dialog.component';
    ...
    describe('Parametrage Management Delete Component', () => {
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ParametrageDeleteDialogComponent],
                providers: [
                    ParametrageService
                ]
            })
