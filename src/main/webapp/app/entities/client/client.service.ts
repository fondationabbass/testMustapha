...
export class ClientService {
    ...
    private convertItemFromServer(client: Client): Client {
        ...
        copy.dateCreat = this.dateUtils
            .convertLocalDateFromServer(client.dateCreat);
        copy.dateMaj = this.dateUtils
            .convertLocalDateFromServer(client.dateMaj);
        return copy;
    }
    ...
    private convert(client: Client): Client {
        const copy: Client = Object.assign({}, client);
        copy.dateCreat = this.dateUtils
            .convertLocalDateToServer(client.dateCreat);
        copy.dateMaj = this.dateUtils
            .convertLocalDateToServer(client.dateMaj);
        return copy;
    }
}
