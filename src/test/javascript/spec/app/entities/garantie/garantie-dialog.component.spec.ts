...
import { GarantieDialogComponent } from '../../../../../../main/webapp/app/entities/garantie/garantie-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Garantie Management Dialog Component', () => {
        let comp: GarantieDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(GarantieDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'garantieListModification', content: 'OK'});
